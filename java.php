...
<div class="header">
	...
	<div class="quiz-container">
		<form action="javascore.php" method="post" id="quiz-form">
			<div class="question-container">
				<h2>Question 1</h2>
				<p>  Which of the following is a type of polymorphism in Java Programming?</p>
                <input type="radio" name="q1" value="a">a) Multiple polymorphism<br>
				<input type="radio" name="q1" value="b">b) Compile time polymorphism<br>
				<input type="radio" name="q1" value="c">c)Multilevel polymorphism<br>
                <input type="radio" name="q1" value="d">d)Execution time polymorphism</p><br>
			</div>
			<div class="question-container">
				<h2>Question 2</h2>
